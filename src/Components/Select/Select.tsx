...
const Select: React.FC<SelectProps> = ({ label, options, defaultValue, style, className, setSelectedValueProp }) => {
  ...
  return (
    <div>
      ...
      <select
        id="default"
        className={`bg-gray-50 border border-gray-300 text-black mb-6 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500 ${className || ''}`}
